...
2026-09-14 更新：自动联网检索补充校园问答和内容生成，引用格式问题改为资料提示；支持高德在线地图、设备/IP持续定位和四种固定导览语音。配置、行为及限制见 [联网与地图说明](docs/WEB_SEARCH_AND_MAPS.md)。下方 R2 部分保留此前验收记录，地图当前状态以本机 `/api/maps/status` 为准。
